...
describe("NFT Shop", async () => {
  ...
  describe("When a user purchase an ERC20 from the Token contract", async () => {
    ...
    beforeEach(async () => {
      ...
      const purchaseTokenTx = await projectCreator.purchaseTokens({
    ...
    describe("When a user burns an ERC20 at the Token contract", async () => {
      ...
      beforeEach(async () => {
        ...
        const returnTokensTx = await projectCreator.returnTokens(tokensEarned);
    ...
    describe("When a user purchase a NFT from the Shop contract", () => {
      ...
      beforeEach(async () => {
        ...
        const purchaseNftTx = await projectCreator.purchaseNft(NFT_ID);
        await purchaseNftTx.wait();
        ownerPool = await projectCreator.ownerPool();
        publicPool = await projectCreator.publicPool();
      });
      ...
      describe("When a user burns their NFT at the Shop contract", async () => {
        ...
        beforeEach(async () => {
          ...
          const returnNftTx = await projectCreator.returnNft(NFT_ID);
        ...
        it("updates the pool correctly", async () => {
          const publicPoolAfter = await projectCreator.publicPool();
      ...
      describe("When the owner withdraw from the Shop contract", async () => {
        ...
        beforeEach(async () => {
          ...
          const withdrawTx = await projectCreator.ownerWithdraw(withdrawValue);
        ...
        it("updates the owner account correctly", async () => {
          const newOwnerPoolValue = await projectCreator.ownerPool();
